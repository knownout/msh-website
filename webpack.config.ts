...
function defaultServerConfiguration ({
	...
	const certificatesPath = "C:\\Users\\slav\\storage\\.cert";
	const httpsConfiguration = {
		key: readFileSync(`${certificatesPath}\\localhost+3-key.pem`, "utf8"),
		cert: readFileSync(`${certificatesPath}\\localhost+3.pem`, "utf8")
	};
